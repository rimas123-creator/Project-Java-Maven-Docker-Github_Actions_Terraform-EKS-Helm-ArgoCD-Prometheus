...
resource "aws_internet_gateway" "main" {
  ...
  tags = {
    Name = "${terraform.workspace}-${var.cluster_name}-igw"
  }
}
...
resource "aws_eip" "nat" {
  ...
  tags = {
    Name = "${terraform.workspace}-${var.cluster_name}-nat-${count.index + 1}"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "${terraform.workspace}-${var.cluster_name}-public"
  }
}
